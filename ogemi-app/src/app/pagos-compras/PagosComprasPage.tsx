...
import { Compra, BancoCuenta, Proveedor, Empresa, EMPRESA_LABEL } from '@/types'
...
function PagosComprasPage({ empresa }: { empresa: Empresa }) {
  ...
  return (
    <AppLayout>
      ...
      <Header title={`Pago de compras ${EMPRESA_LABEL[empresa]}`} subtitle="Pago múltiple de compras por proveedor" />
...
export default PagosComprasPage
export const PagosComprasOgemi = withPagePermission(() => <PagosComprasPage empresa="ogemi" />, 'compras', 'ver')
export const PagosComprasImpresos = withPagePermission(() => <PagosComprasPage empresa="impresos" />, 'compras', 'ver')
