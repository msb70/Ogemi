...
export function footer(slide, ctx, n) {
  ...
  txt(slide, ctx, "Automind Group / Propuesta económica para OGEMI - Impresos Comerciales SA", 58, 681, 620, 16, { size: 8.5, color: C.muted });
...
export function bar(slide, ctx, label, value, max, x, y, w, color) {
  ...
  txt(slide, ctx, `${value.toLocaleString("es-ES")} EUR`, x + 205 + w, y - 2, 96, 22, { size: 10.5, color: C.ink, bold: true, align: "right" });
}
